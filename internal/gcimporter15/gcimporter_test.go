...
func testPath(t *testing.T, path, srcDir string) *types.Package {
	t0 := time.Now()
	pkg, err := Import(&build.Default, make(map[string]*types.Package), path, srcDir)
	if err != nil {
...
func TestImportedTypes(t *testing.T) {
	...
	for _, test := range importedObjectTests {
		...
		pkg, err := Import(&build.Default, make(map[string]*types.Package), importPath, ".")
		if err != nil {
			t.Error(err)
			continue
		}
...
func TestIssue5815(t *testing.T) {
	...
	pkg, err := Import(&build.Default, make(map[string]*types.Package), "strings", ".")
	if err != nil {
		t.Fatal(err)
	}
...
func TestCorrectMethodPackage(t *testing.T) {
	...
	_, err := Import(&build.Default, imports, "net/http", ".")
	if err != nil {
		t.Fatal(err)
	}
...
func TestIssue13566(t *testing.T) {
	...
	pkg, err := Import(&build.Default, make(map[string]*types.Package), "./testdata/b", ".")
	if err != nil {
		t.Fatal(err)
	}
...
func TestIssue13898(t *testing.T) {
	...
	imports := make(map[string]*types.Package)
	_, err := Import(&build.Default, imports, "go/internal/gcimporter", ".")
	if err != nil {
		t.Fatal(err)
	}
...
func TestIssue15517(t *testing.T) {
	...
	imports := make(map[string]*types.Package)
	for i := 0; i < 3; i++ {
		if _, err := Import(&build.Default, imports, "./././testdata/p", "."); err != nil {
			t.Fatal(err)
		}
	}
}
...
func TestIssue15920(t *testing.T) {
	...
	imports := make(map[string]*types.Package)
	if _, err := Import(&build.Default, imports, "./testdata/issue15920", "."); err != nil {
		t.Fatal(err)
	}
}
